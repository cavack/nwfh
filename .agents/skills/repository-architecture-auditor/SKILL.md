...
description: Use when routing to the canonical repository-architecture-auditor skill.
---
...
2. Read `../../../skills/waterfallhunter/repository-architecture-auditor/SKILL.md`.
