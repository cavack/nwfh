...
description: Use when routing to the canonical observability-incident-response skill.
---
...
2. Read `../../../skills/waterfallhunter/observability-incident-response/SKILL.md`.
